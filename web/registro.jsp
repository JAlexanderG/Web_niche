...
<html lang="es">
    ...
    <body>
        ...
        <section class="form box-shadow-1">
            <div class="form-group">
                ...
                <form action="" method="post" autocomplete="off">
                    <div class="input-group">
                        <input type="text" name="txt_nombres" id="txt_nombres" class="input" placeholder=" " required>
                        <label class="placeholder">Nombres</label>
                    </div>
                    <div class="input-group">
                        <input type="text" name="txt_apellidos" id="txt_apellidos" class="input" placeholder=" " required>
                        <label class="placeholder">Apellidos</label>
                    </div>  
                    <div class="input-group">
                        <input type="email" name="txt_correo" id="txt_correo" class="input" placeholder=" " title="Email incorrecto"
                        pattern="^[a-z0-9]+(\.[_a-z0-9]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,15})$" required>
                        <label class="placeholder">Correo Electrónico</label>
                    </div>    
                    <div class="input-group">
                        <input type="password" name="txt_pass" id="txt_pass" class="input" placeholder=" " required="">
                        <label class="placeholder">Contraseña</label>
                    </div>
                    <div class="input-group">
                        <input type="number" name="txt_telefono" id="txt_telefono" class="input" placeholder=" " required>
                        <label class="placeholder">Teléfono</label>
                    </div> 
                    <button class="btn" name="btn_registrar" value="registrar" >Registrar</button>
                    <a class="btn btn-2" href="login.jsp">Regresar</a>  
                </form>
            </div>
        </section>
